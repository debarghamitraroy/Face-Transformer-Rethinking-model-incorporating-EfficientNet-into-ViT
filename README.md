...
[Prof. Srinibas Rana\*](https://www.linkedin.com/in/srinibas-rana-aa131b89/) &emsp; [Debargha Mitra Roy](https://www.linkedin.com/in/debarghamitraroy/) &emsp; [Bikash Shaw](https://www.linkedin.com/in/shawbikash4/) &emsp; [Suprio Kundu](https://www.linkedin.com/in/suprio-kundu/)

Jalpaiguri Government Engineering College

[![Publication](https://img.shields.io/badge/Publication-Face%20Trasformer-red?style=flat&logo=googledocs&logoColor=red)][def56]
[![Implementation](https://img.shields.io/badge/Implementation%20from-zhongyy%2FFace%20Transformer-%23181717?style=flat&logo=github)][def1]
...
> ## Abstract:
>
> _<p align="justify">We propose a hybrid architecture synergistically combining the strengths of both architectures, aiming for robust and efficient face recognition. Face recognition has achieved remarkable progress in recent years, but challenges remain in terms of robustness, efficiency, and scalability. Transformers have emerged as powerful models for various vision tasks, but their direct application to face recognition faces challenges due to computational cost and potential overfitting. EfficientNets, on the other hand, offer a balance of accuracy and efficiency in convolutional neural networks. In this work, we propose a novel approach that rethinks face transformers by integrating EfficientNets with ViT. We explore a hybrid architecture that leverages the strengths of both transformers and EfficientNets, aiming to achieve robust and efficient face recognition. We employ EfficientNets as a backbone for feature extraction, extracting informative and compact features while maintaining computational efficiency. Our findings demonstrate that the proposed hybrid architecture significantly surpasses existing methods in face recognition performance while maintaining excellent computational efficiency. It paves the way for developing robust, efficient, and scalable face recognition systems with diverse applications, ranging from security and access control to personalized user experiences and social media.</p>_
...
This code is mainly adopted from [Vision Transformer][def2], [DeiT][def3] & [Face Evolve][def49]. In addition to `PyTorch` and `torchvision`, install [`vit_pytorch`][def2] by [Phil Wang][def4], [`efficientnet_pytorch`][def50] by [Luke Melas-Kyriazi][def52] & package [`timm`][def5] by [Ross Wightman][def6]. Sincerely appreciate for their contributions.

All needed Packages are found in [`requirements.txt`][def51]. Simply install all packages by:
...
- You can download the training databases, **CASIA-Webface** (version - [`casia-webface`][def9]), and put it in folder `Data`.

  |       Dataset        | Baidu Netdisk | Password | Google Drive  |   Onedrive   |    Website    |    GitHub     |    Kaggle     |
  | :------------------: | :-----------: | :------: | :-----------: | :----------: | :-----------: | :-----------: | :-----------: |
  | `ms1m-retinaface-t1` | [LINK][def7]  |  `4ouw`  |               | [LINK][def8] |               |               |
  |   `CASIA-Webface`    | [LINK][def9]  |          | [LINK][def10] |              |               |               | [LINK][def48] |
  |      `UMDFace`       | [LINK][def11] |          | [LINK][def12] |              |               |               |
  |        `VGG2`        | [LINK][def13] |          | [LINK][def14] |              |               |               |
  |     `MS1M-IBUG`      | [LINK][def15] |          |               |              |               |               |
  |    `MS1M-ArcFace`    | [LINK][def16] |          | [LINK][def17] |              |               |               |
  | `MS1M-RetinaFace-t1` | [LINK][def18] |  `8eb3`  | [LINK][def19] |              |               |               |
...
The content of [`property`][def53] file for [`casia-webface`][def54] dataset is as follows: $10572, 112, 112$
...
This is the research paper of [Face Transformer for Recognition][def], forked from [`zhongyy/Face-Transformer`][def1].

## Contact

If you have any questions, please create an issue on this repository or contact at [`debarghamitraroy@gmail.com`][def55]
...
[def10]: https://drive.google.com/file/d/1KxNCrXzln0lal3N4JiYl9cFOIhT78y1l/view
